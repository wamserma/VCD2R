...
With the mighty statistical toolset of R at our hands, we can try many more attacks. We applied Correlation and Mutual Information Analysis, we could try Regression Models, Clustering, Classify parts of traces with Random Forests, or even use combinations of those!

MIA: kris.kalish.net/2013/11/mutual-information-in-r/, packages entropy and infotheo
